...
contract GovernorAlpha {
    ...
    string public constant name = "gAKITA Governor Alpha";
    ...
    /// @notice The address of the gAKITA Protocol Timelock
    TimelockInterface public timelock;

    /// @notice The address of the gAKITA governance token
    gAKITAInterface public gAKITA;
    ...
    constructor(address timelock_, address gAKITA_) public {
        timelock = TimelockInterface(timelock_);
        gAKITA = gAKITAInterface(gAKITA_);
    }
    ...
    function propose(
        ...
        require(
            gAKITA.getPriorVotes(msg.sender, sub256(block.number, 1)) >=
                proposalThreshold(),
        ...
        uint256 endTime =
            add256(block.timestamp, add256(votingPeriod(), votingDelay()));
    ...
    function cancel(uint256 proposalId) public {
        ...
        Proposal storage proposal = proposals[proposalId];
        require(
            gAKITA.getPriorVotes(proposal.proposer, sub256(block.number, 1)) <
                proposalThreshold(),
    ...
    function _castVote(
        ...
        uint96 votes = gAKITA.getPriorVotes(voter, proposal.startBlock);
